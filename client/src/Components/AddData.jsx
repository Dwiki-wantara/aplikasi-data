    ...
    <>
      ...
      <div className="bg-white centered w-[90%] md:w-[35rem] z-50 rounded-lg px-4 py-8 ">
        ...
        <form className="mt-6" onSubmit={(e) => handleSubmit.mutate(e)}>
          ...
          <button
            type="submit"
            className="w-full m-auto py-2 bg-blue-600 hover:bg-white-600 rounded-md font-bold text-white mb-3"
          >
            {" "}
            Simpan{" "}
          </button>
          <button
            className="w-full m-auto py-2 bg-white border border-blue-600 rounded-md font-bold text-dark-600 hover:bg-transparent"
